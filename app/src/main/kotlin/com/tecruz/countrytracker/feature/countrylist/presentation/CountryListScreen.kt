...
import com.tecruz.countrytracker.core.ui.components.worldmap.WorldMapCanvas
        ...
        item {
            FilterChip(
                ...
                label = { 
                    Text(
                        allRegionLabel,
                        fontWeight = if (selectedRegion == "All" || selectedRegion == allRegionLabel) FontWeight.Bold else FontWeight.Medium
                    ) 
                },
                ...
                border = FilterChipDefaults.filterChipBorder(
                    enabled = true,
                    selected = selectedRegion == "All" || selectedRegion == allRegionLabel,
                    borderColor = if (selectedRegion == "All" || selectedRegion == allRegionLabel) Color.Transparent else Outline.copy(alpha = 0.5f),
                    selectedBorderColor = Color.Transparent
                )
            )
        }
