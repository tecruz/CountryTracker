...
class CountryListViewModel @Inject constructor(
    ...
    val uiState: StateFlow<CountryListUiState> = combine(
        ...
        val countries = flows[0] as List<Country>
        ...
        val debouncedSearchQuery = flows[3] as String
        ...
        try {
            val filteredCountries = countries
                .filter { country ->
                    ...
                    val searchMatch = debouncedSearchQuery.isEmpty() ||
                        country.name.contains(debouncedSearchQuery, ignoreCase = true)
