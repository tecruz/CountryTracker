package com.tecruz.countrytracker.core.ui.components.worldmap
 ...
 * @param onCountryClick Callback when a country is tapped (unused, kept for compatibility)
 * @param modifier Modifier for the Canvas
 * @param visitedColor Color for visited countries
...
fun WorldMapCanvas(
    ...
    visitedColor: Color = VisitedColorLight,
 ...
 */
private fun DrawScope.drawCountryShadow(
    path: Path,
    scale: Float,
    offsetX: Float,
    offsetY: Float
